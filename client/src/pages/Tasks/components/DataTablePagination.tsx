...
function DataTablePagination({
    ...
    return (
        <div className="flex items-center justify-between px-2">
            <div className="flex-1 flex flex-col gap-3 justify-center text-sm text-muted-foreground">
                <p>{data.completedTasks} of {data.totalNumberOfTasks} tasks completed.</p>
                <div className="flex flex-col gap-2">
                    <p>Your progress: </p>
                    <Progress className="w-[500px] h-3" value={(data?.completedTasks / data?.totalNumberOfTasks) * 100}/>
                </div>
            </div>
